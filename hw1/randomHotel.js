...
var RandomHotel = /** @class */ (function () {
    function RandomHotel(marketCode, enviroment) {
        if (enviroment === void 0) { enviroment = 'integration'; }
    ...
    RandomHotel.prototype.initialize = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a.allPackages = _b.sent();
                        return [2 /*return*/];
                }
            });
        });
    };
    RandomHotel.prototype.getHotelNames = function () {
        return this.allPackages.items.map(function (item) {
            return item.hotel.value;
        });
    };
    RandomHotel.prototype.getRandomHotelName = function () {
